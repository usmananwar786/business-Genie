  ...
  head: () => ({
    meta: [
      ...
      { title: "Business Genie Consulting" },
      {
        name: "description",
        content:
          "Business Genie Consulting provides ERP implementation, digital marketing, SEO, web development, UI/UX design and business automation services.",
      },
      { name: "author", content: "Business Genie Consulting" },
